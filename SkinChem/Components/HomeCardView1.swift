...
struct HomeCardView1: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: UIScreen.main.bounds.height * 0.01) {
            ...
            ProgressView(value: sunScoreProgressBar/5)
...
struct HomeCardView1_Previews: PreviewProvider {
    static var previews: some View {
        HomeCardView1(score: 1, title: "Sun", image: "sun", riskText: "High Risk")
    }
}
